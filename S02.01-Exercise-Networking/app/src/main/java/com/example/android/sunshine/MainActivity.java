...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData() {
        ...
        URL weatherDataUrl = NetworkUtils.buildUrl(preferredLocation);
        new NetworkRequests().execute(weatherDataUrl);
    }
    ...
    // COMPLETED (6) Override the doInBackground method to perform your network requests
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try {
                weatherDataResults = NetworkUtils.getResponseFromHttpUrl(url);

                String[] simpleJsonWeatherData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, weatherDataResults);
        ...
        protected void onPostExecute(String[] weatherDataResults) {
            if (weatherDataResults != null) {
                for (String weather: weatherDataResults)
